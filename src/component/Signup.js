...
const Signup = () => {
  return (<>
  <Nav/>
    <main className="w-full h-screen flex flex-col items-center justify-center bg-fuchsia-50 sm:px-4">
      <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
        <div className="text-center ">
          ...
          <div className="mt-5 space-y-2">
            ...
            <p className="">هل لديك حساب؟ <Link to="/Login" className="font-medium text-fuchsia-800 hover:text-fuchsia-500">تسجيل الدخول</Link></p>
          </div>
        </div>
